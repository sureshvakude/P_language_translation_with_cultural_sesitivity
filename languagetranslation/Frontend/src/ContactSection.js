    ...
    <section className="contacts4 map1 cid-u87MqKUNBd" id="contacts-3-u87MqKUNBd">
      <div className="main_wrapper">
            ...
            <div className="row justify-content-start">
              <div className="col-md-5 col-lg-4 item-wrapper">
                ...
                <ul className="list mbr-fonts-style display-7">
                  ...
                  <li className="mbr-text item-wrap">Address: Chikkodi India</li>
        ...
        <div className="google-map">
          <iframe title="Google Map" frameBorder="0" style={{ border: 0 }} src="https://www.google.com/maps/embed/v1/place?key&#x3D;AIzaSyCt1265A4qvZy9HKUeA8J15AOC4SrCyZe4&amp;q&#x3D;Chikkodi%20India" allowFullScreen=""></iframe>
        </div>
      </div>
    </section>
  );
